...
6. [Approach Overview](#approach-overview)
7. [Approach 1 — Clustering-Based Labeling (V1)](#approach-1--clustering-based-labeling-v1)
8. [Approach 2 — Threshold-Based Labeling (V2) ✅ Best Results](#approach-2--threshold-based-labeling-v2--best-results)
